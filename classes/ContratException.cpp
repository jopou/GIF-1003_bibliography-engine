 ...
 * \brief Implementation de la classe ContratException et de ses classes derivees
 * \author Guillaume Gagnon
 * \date 1er novembre 2021, 11:20
 */
 ...
 */
ContratException::ContratException (std::string p_fichP, unsigned int p_prmLigne, std::string p_exprP, std::string p_msgP) : logic_error (p_msgP), m_expression (p_exprP), m_fichier (p_fichP), m_ligne (p_prmLigne) { }
